...
MOVIES_DB_NAME = "sample_mflix"
obmovies = MongoClient(host)[MOVIES_DB_NAME]
...
cursor = obmovies.movies.find(predicate, projection)
...
try:
    ...
    bulk_results = obmovies.movies.bulk_write(bulk_updates)
